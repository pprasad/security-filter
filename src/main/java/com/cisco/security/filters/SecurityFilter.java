...
public class SecurityFilter implements Filter {
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,FilterChain filterChain)
	     ...
	     if(isCrossSiteRequest(requestWrapper) && isMethodAllow){
	    	 if((requestBody!=null && isVulnerability(requestBody) && queryString!=null && isVulnerability(queryString) 
	    			 && isHeaderAllow) || 
	    			 ...
	    			 (requestBody!=null && isVulnerability(requestBody)) || (queryString!=null && isVulnerability(queryString)) || 
	    			 isHeaderAllow|| (requestBody==null && queryString==null && isHeaderAllow)) {
